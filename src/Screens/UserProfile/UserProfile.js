    ...
    if(this.state.profile.mylist && this.state.profile.mylist.status){
        ...
        style={{
          ...
          <TouchableOpacity onPress={() => this.createChats()}>
            <View
              ...
              <IconImage source={UserProfileIcons['message']} resizeMode="contain"></IconImage>
          ...
          <TouchableOpacity onPress={() => this.disconnectRequest()} 
            ...
            <View
              ...
              <IconImage source={UserProfileIcons['disconnect']} resizeMode="contain"></IconImage>
            </View>
          </TouchableOpacity>
        </View>
      );
      ...
      btns.push(
        <View key={'btnPending'}
          ...
          <IconImage source={UserProfileIcons['pending']} resizeMode="contain"></IconImage>
