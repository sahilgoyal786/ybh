...
import {bottomCurve,ProfileIcon12,ProfileNextIcon,HairIcons} from '../../common/images';
import styled from 'styled-components/native';
import {widthPercentageToDP} from 'react-native-responsive-screen';
import {TouchableOpacity} from 'react-native-gesture-handler';
import {Text,ScrollView,View,Image} from 'react-native';
import Header from '../../components/header';
const PersonalInfo12 = () => {
    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <ScrollView
        ...
        <ProfileWrap>
          ...
          <TopImage source={ProfileIcon12} resizeMode="contain"></TopImage>
          <Heading>Hair</Heading>
          <SingleElement style={{borderColor: '#f9bc16'}}>
            <PImage source={HairIcons['bald']}></PImage>
            <PText>Bald</PText>
          </SingleElement>
          <SingleElement>
            <PImage source={HairIcons['long']}></PImage>
            <PText>Long</PText>
          </SingleElement>
          <SingleElement>
            <PImage source={HairIcons['short']}></PImage>
            <PText>Short</PText>
          </SingleElement>
          <TouchableOpacity onPress={() => navigation.navigate('PersonalInfo13')}>
